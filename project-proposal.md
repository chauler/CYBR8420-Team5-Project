...
I learned about different aspects of an open-source project to evaluate when looking to contribute. I have not previously contributed to any "real" open-source projects (ones with governance structures, detailed contribution guidelines, etc.), so I was not aware of these systems and procedures.